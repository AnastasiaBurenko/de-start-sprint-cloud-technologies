...
class AppConfig:
    ...
    def __init__(self) -> None:
        ...
        self.kafka_consumer_username = str(os.getenv('KAFKA_USER'))
        self.kafka_consumer_password = str(os.getenv('KAFKA_PASSWORD'))
        self.kafka_consumer_group = str(os.getenv('KAFKA_GROUP'))
        self.kafka_consumer_topic = str(os.getenv('KAFKA_SOURCE_TOPIC'))
        self.kafka_producer_username = str(os.getenv('KAFKA_USER'))
        self.kafka_producer_password = str(os.getenv('KAFKA_PASSWORD'))
